...
import com.txtspring.autowiring.service.EmployeeAutowiredByConstructorService;
import com.txtspring.autowiring.service.EmployeeAutowiredByTypeService;
import com.txtspring.autowiring.service.EmployeeService;
...
public class SpringMain {
	...
	public static void main(String[] args) {
		...
		EmployeeAutowiredByTypeService autowiredByTypeService = ctx.getBean("employeeAutowiredByTypeService",
		...
		EmployeeAutowiredByConstructorService autowiredByConstructorService = ctx
				.getBean("employeeAutowiredByConstructorService", EmployeeAutowiredByConstructorService.class);
