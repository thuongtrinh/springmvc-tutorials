package com.txt.spring.controller;
...
import com.txt.spring.beans.MyAnnotatedBean;
...
public class HomeController {
	...
	public String home(Locale locale, Model model) {
		...
		model.addAttribute("number", myAnnotatedBean.getEmpId());
		model.addAttribute("name", myBean.getName());
